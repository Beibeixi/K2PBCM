 ...
 *
 * $Id: bcm_rpc.c 497979 2014-08-21 10:14:31Z $
 */
...
bcm_rpc_up(struct rpc_info *rpci)
{
	...
	bcm_rpc_pktlog_init(rpci);
#ifdef WLC_LOW
	if (!hnd_cons_add_cmd("rpcpktdump", bcm_rpc_dump_pktlog_low, rpci))
		return BCME_ERROR;
#endif
#endif /* BCMDBG_RPC */
#ifdef WLC_LOW
	if (!hnd_cons_add_cmd("rpcdump", bcm_rpc_dump_state, rpci))
		return BCME_ERROR;
#endif
	return BCME_OK;
}
