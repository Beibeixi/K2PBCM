...
#define QUAGGA_CONFIG_ARGS "--host=arm-linux --build=x86_64-linux-gnu --prefix=/usr --sysconfdir=/etc --enable-shared --disable-static --disable-ripngd --disable-ospfd --disable-doc --disable-ospfclient --disable-ospf6d --disable-bgpd --disable-bgp-announce --disable-babeld --disable-silent-rules --disable-isisd"
