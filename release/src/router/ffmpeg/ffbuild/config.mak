...
OBJCC=arm-brcm-linux-uclibcgnueabi-gcc
...
ARFLAGS=rcD
AR_O=$@
AR_CMD=arm-brcm-linux-uclibcgnueabi-ar
NM_CMD=arm-brcm-linux-uclibcgnueabi-nm -g
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -I$(SRC_PATH)/compat/atomics/gcc
CFLAGS=-DRTAC1200GP -DRTAC1200GP -DBCMWPA2 -DBCMQOS -DEXT_ACS -DD11AC_IOTYPES -DPHYMON -DPROXYARP -DTRAFFIC_MGMT -DTRAFFIC_MGMT_RSSI_POLICY -DMFP -D__CONFIG_MFP__ -DLINUX26 -DCONFIG_BCMWL5 -DDEBUG_NOISY -DDEBUG_RCTEST -pipe -DBCMWPA2 -DBCMARM -fno-strict-aliasing -marm -DRTCONFIG_NVRAM_64K -DLINUX_KERNEL_VERSION=132644  -DRTAC1200GP -O2 -DBCM_DCS -D__CONFIG_EMF__ -D__CONFIG_WPS__  -Os -ffunction-sections -fdata-sections -fPIC -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++0x
OBJCFLAGS=  
ASFLAGS=  -Os -ffunction-sections -fdata-sections -fPIC -march=armv7-a -fPIC
...
LD_PATH=-L
DLLTOOL=
WINDRES=arm-brcm-linux-uclibcgnueabi-windres
DEPWINDRES=arm-brcm-linux-uclibcgnueabi-gcc
DOXYGEN=doxygen
LDFLAGS=-ldl -ffunction-sections -fdata-sections -Wl,--gc-sections -fPIC  -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
