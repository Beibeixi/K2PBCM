...
export ac_prefix := /home/plp/k2p/asuswrt/release/src/router/asusnatnl/pjproject-1.12/_inst
...
export PJDIR := /home/plp/k2p/asuswrt/release/src/router/asusnatnl/pjproject-1.12
export APP_CC := arm-brcm-linux-uclibcgnueabi-gcc
export APP_CXX := arm-brcm-linux-uclibcgnueabi-g++
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-I/home/plp/k2p/asuswrt/release/src-rt-9.x/src/router/openssl/include  -g -O2 -fPIC -DROUTER=1  -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	-L/home/plp/k2p/asuswrt/release/src-rt-9.x/src/router/openssl    
...
export PJ_INSTALL_DIR := /home/plp/k2p/asuswrt/release/src/router/asusnatnl/pjproject-1.12/_inst
export PJ_INSTALL_INC_DIR := $(PJ_INSTALL_DIR)/include
export PJ_INSTALL_LIB_DIR := $(PJ_INSTALL_DIR)/lib
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	-I/home/plp/k2p/asuswrt/release/src-rt-9.x/src/router/openssl/include  -g -O2 -fPIC -DROUTER=1  -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
